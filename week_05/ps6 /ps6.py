...
def get_story_string():
    ...
    """
    f = open("/home/matekovacsbodor/gitstudyfolder/edx_mit_cs/week_05/ps6 /story.txt", "r")
    story = str(f.read())
    f.close()
    return story

WORDLIST_FILENAME = '/home/matekovacsbodor/gitstudyfolder/edx_mit_cs/week_05/ps6 /words.txt'
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        best_shift = 0
        for i in range(26):
            new_decryption = self.apply_shift(i)
            good_words_num = 0
            for word in new_decryption.split(' '):
                if word in self.valid_words:
                    good_words_num += 1
            if good_words_num > best_word_num:
                best_word_num = good_words_num
                decrypted_string = new_decryption
                best_shift = i
        return (best_shift, decrypted_string)
...
chipertext =  CiphertextMessage(story)
# chipertext.decrypt_message()
